...
options = VarParsing()
options.register("config", "miniaod_2023_cfg", VarParsing.multiplicity.singleton, VarParsing.varType.string, "cmsDriver-generated config to import")
...
#options.register("address", "triton-run3.cms.geddes.rcac.purdue.edu", VarParsing.multiplicity.singleton, VarParsing.varType.string, "server address")
options.register("address", "128.211.142.16", VarParsing.multiplicity.singleton, VarParsing.varType.string, "server address")
...
#modifier_names = ["enableSonicTriton","particleTransformerAK4SonicTriton"] + [x for x in options.modifiers]
#modifier_names = ["enableSonicTriton","particleNetSonicTriton"] + [x for x in options.modifiers]
